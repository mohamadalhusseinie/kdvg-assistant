            ...
            <main className="mx-auto flex max-w-4xl flex-col gap-10 px-6 py-16">
                <header className="flex flex-col gap-4">
                    ...
                    <p className="text-base text-muted-foreground">
                        Der Kriegsdienst mit der Waffe kann aus Gewissensgründen verweigert werden.
                        Dieses Recht ist im Grundgesetz verankert.
                    </p>

                    <p className="text-base text-muted-foreground">
                        In der Praxis ist der Weg dorthin für viele unübersichtlich: Welche Angaben
                        sind nötig? Wie formuliert man eine persönliche Begründung? Und was gehört
                        überhaupt in den Antrag?
                    </p>

                    <p className="text-base text-muted-foreground">
                        Dieser Assistent hilft dabei, die eigenen Gedanken zu ordnen und die
                        erforderlichen Unterlagen strukturiert vorzubereiten. Am Ende entsteht ein
                        druckbares PDF, das selbst unterschrieben und bei der zuständigen Stelle
                    ...
                    <span className="text-xs text-muted-foreground">
                        Es handelt sich hierbei um keine Rechtsberatung und keine automatische Einreichung. Die Verarbeitung findet ausschließlich im Browser statt.
                    </span>
                </header>
                ...
                <section className="grid gap-6 md:grid-cols-2">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Die Debatte um den Wehrdienst und die Wehrpflicht ist wieder da – und viele wollen vorbereitet sein.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-3 text-sm">
                            <p>
                                Die sicherheitspolitische Lage in Europa ist seit Jahren angespannt. Parallel wird in
                                Deutschland offener darüber gesprochen, wie schnell die Bundeswehr personell
                                aufwachsen könnte – inklusive Modellen für einen <strong>Wehrdienst</strong> auf freiwilliger Basis
                                und einer möglichen <strong>Wehrpflicht</strong>-Option, falls Freiwilligkeit nicht reicht.
                            </p>

                            <p>
                                Unabhängig davon gilt: Niemand ist verpflichtet, gegen sein Gewissen am
                                Kriegsdienst mit der Waffe teilzunehmen.
                            </p>
                            <p>
                                Artikel 4 Absatz 3 des Grundgesetzes garantiert das Recht, den Kriegsdienst
                                aus Gewissensgründen zu verweigern.
                            </p>
                            <p className="text-muted-foreground">
                                Entscheidend ist dabei eine persönliche, in sich schlüssige Begründung der
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-3 text-sm">
                            <p>
                                Anträge auf Kriegsdienstverweigerung werden nicht bei dieser Anwendung,
                                sondern bei staatlichen Stellen eingereicht.
                            </p>
                            <p>
                            ...
                            <p className="text-muted-foreground">
                                Der Assistent erstellt diese Unterlagen als zusammenhängendes PDF. Die
                                Prüfung, Unterschrift und Einreichung erfolgen eigenverantwortlich.
                            </p>
